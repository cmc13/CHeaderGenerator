...
*/";
        ...
        [Description("Format string to use for any {Date} token in Header Comment")]
            ...
            set
            {
                ...
                if (this.dateFormat != value)
                {
                    try {
                        ...
                        this.OnPropertyChanged(() => this.DateFormat);
                    } catch(FormatException) {
                        string errorMessage = string.Format(
                            "\"{0}\" is not a valid format string for DateTime objects. See documentation for DateTime.ToString(String)",
                            value ?? String.Empty
                        );
                        MessageBox.Show(errorMessage, "Invalid Format String", MessageBoxButton.OK, MessageBoxImage.Error);
                    }
                }
            }
        }
